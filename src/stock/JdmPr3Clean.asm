...
label_04e0:     MOVB    0b2h, #068h            ; 04E0 0 108 20E C5B29868
                LB      A, 0ach                ; 04E4 0 108 20E F5AC
                MOV     X1, #0345ah            ; 04E6 0 108 20E 605A34
                VCAL    2                      ; 04E9 0 108 20E 12
                SJ      label_0517             ; 04EA 0 108 20E CB2B
                                               ; 04EC from 04DD (DD0,108,20E)
label_04ec:     L       A, 0b0h                ; 04EC 1 108 20E E5B0
                SWAP                           ; 04EE 1 108 20E 83
                LB      A, ACC                 ; 04EF 0 108 20E F506
                CMPB    A, #0a1h               ; 04F1 0 108 20E C6A1
                JGT     label_04f9             ; 04F3 0 108 20E C804
                CMPB    A, #00bh               ; 04F5 0 108 20E C60B
                JGE     label_04fc             ; 04F7 0 108 20E CD03
                                               ; 04F9 from 04F3 (DD0,108,20E)
label_04f9:     SC                             ; 04F9 0 108 20E 85
                SJ      label_051a             ; 04FA 0 108 20E CB1E
                                               ; 04FC from 04F7 (DD0,108,20E)
label_04fc:     STB     A, 0b2h                ; 04FC 0 108 20E D5B2
                CMPB    A, #070h               ; 04FE 0 108 20E C670
                JGT     label_050d             ; 0500 0 108 20E C80B
                MB      C, ACCH.7              ; 0502 0 108 20E C5072F
                ROLB    A                      ; 0505 0 108 20E 33
                SUBB    A, #030h               ; 0506 0 108 20E A630
                JGE     label_0517             ; 0508 0 108 20E CD0D
                CLRB    A                      ; 050A 0 108 20E FA
                SJ      label_0517             ; 050B 0 108 20E CB0A
                                               ; 050D from 0500 (DD0,108,20E)
label_050d:     ADDB    A, #040h               ; 050D 0 108 20E 8640
                JLT     label_0515             ; 050F 0 108 20E CA04
                CMPB    A, #0e0h               ; 0511 0 108 20E C6E0
                JLT     label_0517             ; 0513 0 108 20E CA02
                                               ; 0515 from 050F (DD0,108,20E)
label_0515:     LB      A, #0dfh               ; 0515 0 108 20E 77DF
                                               ; 0517 from 04EA (DD0,108,20E)
                                               ; 0517 from 0508 (DD0,108,20E)
                                               ; 0517 from 050B (DD0,108,20E)
                                               ; 0517 from 0513 (DD0,108,20E)
label_0517:     STB     A, 0b3h                ; 0517 0 108 20E D5B3
...
label_052d:     CLR     A                      ; 052D 1 108 20E F9
                ...
                JGT     label_0548             ; 053E 0 108 20E C808
...
label_058a:     L       A, ADCR7               ; 058A 1 108 20E E56E
                ...
                MB      C, off(00123h).3       ; 059B 1 108 20E C4232B
                MB      off(00123h).4, C       ; 059E 1 108 20E C4233C
...
label_05a9:     ADDB    A, #003h               ; 05A9 0 108 20E 8603
                ...
                MB      off(00123h).3, C       ; 05AE 0 108 20E C4233B
                MB      C, off(0011fh).6       ; 05B1 0 108 20E C41F2E
                MB      off(0011fh).7, C       ; 05B4 0 108 20E C41F3F
                MB      C, off(0011fh).5       ; 05B7 0 108 20E C41F2D
                MB      off(0011fh).6, C       ; 05BA 0 108 20E C41F3E
                LB      A, #046h               ; 05BD 0 108 20E 7746
                MOVB    r0, #077h              ; 05BF 0 108 20E 9877
                JGE     label_05c7             ; 05C1 0 108 20E CD04
                LB      A, #04eh               ; 05C3 0 108 20E 774E
                MOVB    r0, #089h              ; 05C5 0 108 20E 9889
                                               ; 05C7 from 05C1 (DD0,108,20E)
label_05c7:     CMPB    0a6h, A                ; 05C7 0 108 20E C5A6C1
                JGE     label_05d0             ; 05CA 0 108 20E CD04
                LB      A, r0                  ; 05CC 0 108 20E 78
                CMPB    0b3h, A                ; 05CD 0 108 20E C5B3C1
                                               ; 05D0 from 05CA (DD0,108,20E)
label_05d0:     MB      off(0011fh).5, C       ; 05D0 0 108 20E C41F3D
...
label_05df:     ST      A, 0c2h                ; 05DF 1 108 20E D5C2
                ...
                CMPB    0a4h, #04fh            ; 05E3 0 108 20E C5A4C04F
                JGE     label_061d             ; 05E7 0 108 20E CD34
...
label_05f8:     INCB    r7                     ; 05F8 0 108 20E AF
                ...
                MOVB    r1, #010h              ; 05FF 0 108 20E 9910
                JBR     off(00125h).2, label_0606 ; 0601 0 108 20E DA2502
                MOVB    r1, #010h              ; 0604 0 108 20E 9910
...
label_0676:     ST      A, er0                 ; 0676 1 108 20E 88
                J       label_071c             ; 0677 1 108 20E 031C07
...
label_06b8:     EXTND                          ; 06B8 1 108 20E F8
                ...
                LB      A, 0b3h                ; 06C0 0 108 20E F5B3
                JBS     off(0010fh).0, label_06d0 ; 06C2 0 108 20E E80F0B
                ADDB    A, r2                  ; 06C5 0 108 20E 0A
                JLT     label_06cc             ; 06C6 0 108 20E CA04
                CMPB    A, #0dfh               ; 06C8 0 108 20E C6DF
                JLE     label_06e0             ; 06CA 0 108 20E CF14
                                               ; 06CC from 06C6 (DD0,108,20E)
label_06cc:     LB      A, #0dfh               ; 06CC 0 108 20E 77DF
                SJ      label_06e0             ; 06CE 0 108 20E CB10
...
label_06d0:     CMPB    0a4h, #080h            ; 06D0 0 108 20E C5A4C080
                ...
                JLT     label_06e0             ; 06DA 0 108 20E CA04
                                               ; 06DC from 06D4 (DD0,108,20E)
label_06dc:     SUBB    A, r2                  ; 06DC 0 108 20E 2A
                JGE     label_06e0             ; 06DD 0 108 20E CD01
                CLRB    A                      ; 06DF 0 108 20E FA
...
label_06e4:     L       A, 0beh                ; 06E4 1 108 20E E5BE
                ...
                JBR     off(00123h).3, label_072f ; 06EC 1 108 20E DB2340
                                               ; 06EF from 0719 (DD1,108,20E)
label_06ef:     SJ      label_0688             ; 06EF 1 108 20E CB97
...
label_0719:     JBS     off(00123h).3, label_06ef ; 0719 1 108 20E EB23D3
                                               ; 071C from 0677 (DD1,108,20E)
label_071c:     RB      off(00120h).3          ; 071C 1 108 20E C4200B
                                               ; 071F from 0717 (DD1,108,20E)
label_071f:     LB      A, 0b3h                ; 071F 0 108 20E F5B3
...
label_072f:     LB      A, 0b3h                ; 072F 0 108 20E F5B3
...
label_0737:     ST      A, off(00150h)         ; 0737 1 108 20E D450
                LB      A, #0dfh               ; 0739 0 108 20E 77DF
                JBS     off(00130h).2, label_0743 ; 073B 0 108 20E EA3005
                JBS     off(00130h).4, label_0743 ; 073E 0 108 20E EC3002
                LB      A, 0b4h                ; 0741 0 108 20E F5B4
                                               ; 0743 from 073B (DD0,108,20E)
                                               ; 0743 from 073E (DD0,108,20E)
label_0743:     STB     A, r6                  ; 0743 0 108 20E 8E
                LB      A, 0a7h                ; 0744 0 108 20E F5A7
                RC                             ; 0746 0 108 20E 95
                MOV     X1, #0388bh            ; 0747 0 108 20E 608B38
                MOV     X2, #0376ch            ; 074A 0 108 20E 616C37
                JBS     off(00118h).7, label_0756 ; 074D 0 108 20E EF1806
                MOV     X1, #03ce5h            ; 0750 0 108 20E 60E53C
                MOV     X2, #03bc6h            ; 0753 0 108 20E 61C63B
...
label_0756:     JBS     off(00129h).7, label_076d ; 0756 0 108 20E EF2914
                ...
                MOV     X1, #0378ch            ; 075E 0 108 20E 608C37
                MOV     X2, #0375ch            ; 0761 0 108 20E 615C37
                JBS     off(00118h).7, label_076d ; 0764 0 108 20E EF1806
                MOV     X1, #03be6h            ; 0767 0 108 20E 60E63B
                MOV     X2, #03bb6h            ; 076A 0 108 20E 61B63B
...
label_0782:     LB      A, off(00130h)         ; 0782 0 108 20E F430
                ...
                ANDB    A, #033h               ; 078D 0 108 20E D633
...
label_07fb:     STB     A, off(00159h)         ; 07FB 0 108 20E D459
                ...
                CMPB    off(001abh), #0c8h     ; 0804 0 108 20E C4ABC0C8
...
label_08c3:     MB      off(0011ah).4, C       ; 08C3 0 108 20E C41A3C
                LB      A, off(00137h)         ; 08C6 0 108 20E F437
...
label_08cc:     JBR     off(00119h).6, label_08d4 ; 08CC 0 108 20E DE1905
                ADDB    A, #0f8h               ; 08CF 0 108 20E 86F8
...
label_0a09:     MOVB    r7, #007h              ; 0A09 0 108 13C 9F07
                ...
                JLT     label_0a88             ; 0A0E 0 108 13C CA78
...
label_0a88:     LB      A, r7                  ; 0A88 0 108 13C 7F
                ...
                LB      A, 09ah                ; 0A97 0 108 13C F59A
                CMPB    A, #003h               ; 0A99 0 108 13C C603
                JLE     label_0ab3             ; 0A9B 0 108 13C CF16
                MOVB    r0, #080h              ; 0A9D 0 108 13C 9880
                ADDB    A, r0                  ; 0A9F 0 108 13C 08
                STB     A, r4                  ; 0AA0 0 108 13C 8C
                LCB     A, 02f45h              ; 0AA1 0 108 13C 909D452F
                SRLB    A                      ; 0AA5 0 108 13C 63
                LB      A, r4                  ; 0AA6 0 108 13C 7C
                JGE     label_0ab4             ; 0AA7 0 108 13C CD0B
                LB      A, 09ah                ; 0AA9 0 108 13C F59A
...
label_0ab4:     STB     A, off(00152h)         ; 0AB4 0 108 13C D452
                MOV     off(00160h), er1       ; 0AB6 0 108 13C 457C60
...
label_0acd:     CMPB    A, 0a6h                ; 0ACD 0 108 13C C5A6C2
                ...
                MOVB    r6, 0b4h               ; 0AD3 0 108 13C C5B44E
                MOVB    r7, 0a6h               ; 0AD6 0 108 13C C5A64F
                MOV     X1, #0398ah            ; 0AD9 0 108 13C 608A39
                MOV     X2, #0377ch            ; 0ADC 0 108 13C 617C37
                JBS     off(00118h).7, label_0ae8 ; 0ADF 0 108 13C EF1806
                MOV     X1, #03de4h            ; 0AE2 0 108 13C 60E43D
                MOV     X2, #03bd6h            ; 0AE5 0 108 13C 61D63B
                                               ; 0AE8 from 0ADF (DD0,108,13C)
label_0ae8:     RB      PSWL.5                 ; 0AE8 0 108 13C A30D
                CAL     label_2af3             ; 0AEA 0 108 13C 32F32A
                CAL     label_2b7c             ; 0AED 0 108 13C 327C2B
                STB     A, off(00140h)         ; 0AF0 0 108 13C D440
                MOVB    r6, 0b4h               ; 0AF2 0 108 13C C5B44E
                MOVB    r7, 0a7h               ; 0AF5 0 108 13C C5A74F
                MOV     X1, #03a98h            ; 0AF8 0 108 13C 60983A
                MOV     X2, #0378ch            ; 0AFB 0 108 13C 618C37
                JBS     off(00118h).7, label_0b07 ; 0AFE 0 108 13C EF1806
                MOV     X1, #03ef2h            ; 0B01 0 108 13C 60F23E
                MOV     X2, #03be6h            ; 0B04 0 108 13C 61E63B
                                               ; 0B07 from 0AFE (DD0,108,13C)
label_0b07:     RB      off(00129h).2          ; 0B07 0 108 13C C4290A
...
label_0b70:     RB      P1.1                   ; 0B70 0 108 13C C52209
                ...
                CMPB    0a4h, #044h            ; 0B79 0 108 13C C5A4C044
...
label_0bc3:     RB      P1.0                   ; 0BC3 0 108 13C C52208
                ...
                JGE     label_0be9             ; 0BCC 0 108 13C CD1B
...
label_0bdb:     CLRB    off(001dfh)            ; 0BDB 0 108 13C C4DF15
                ...
                JLT     label_0bce             ; 0BE7 0 108 13C CAE5
...
label_0bf4:     JBS     off(00123h).3, label_0c12 ; 0BF4 0 108 13C EB231B
                CMPB    0a4h, #034h            ; 0BF7 0 108 13C C5A4C034
                JGE     label_0c13             ; 0BFB 0 108 13C CD16
                LB      A, #046h               ; 0BFD 0 108 13C 7746
...
label_0cd8:     STB     A, r6                  ; 0CD8 0 108 13C 8E
                ...
                JNE     label_0cee             ; 0CE8 0 108 13C CE04
...
label_0d0a:     L       A, 0c4h                ; 0D0A 1 108 13C E5C4
                CMP     A, er0                 ; 0D0C 1 108 13C 48
                NOP                            ; 0D0D 1 108 13C 00
                NOP                            ; 0D0E 1 108 13C 00
                JLT     label_0d20             ; 0D0F 1 108 13C CA0F
                INC     DP                     ; 0D11 1 108 13C 72
                INC     DP                     ; 0D12 1 108 13C 72
                JBS     off(00129h).7, label_0d20 ; 0D13 1 108 13C EF290A
                INC     DP                     ; 0D16 1 108 13C 72
                INC     DP                     ; 0D17 1 108 13C 72
                CMPB    0a4h, #02eh            ; 0D18 1 108 13C C5A4C02E
                JLT     label_0d20             ; 0D1C 1 108 13C CA02
                INC     DP                     ; 0D1E 1 108 13C 72
                INC     DP                     ; 0D1F 1 108 13C 72
...
label_0d43:     MB      off(00128h).3, C       ; 0D43 1 108 13C C4283B
...
label_0dd1:     MB      0f2h.6, C              ; 0DD1 0 108 13C C5F23E
                ...
                MOVB    r0, #04ch              ; 0DD9 0 108 13C 984C
                MOVB    r1, #04ch              ; 0DDB 0 108 13C 994C
                MOVB    r2, #043h              ; 0DDD 0 108 13C 9A43
                MOVB    r3, #051h              ; 0DDF 0 108 13C 9B51
                JBR     off(0012bh).2, label_0dec ; 0DE1 0 108 13C DA2B08
                MOVB    r0, #04ch              ; 0DE4 0 108 13C 984C
                MOVB    r1, #04ch              ; 0DE6 0 108 13C 994C
                MOVB    r2, #043h              ; 0DE8 0 108 13C 9A43
                MOVB    r3, #051h              ; 0DEA 0 108 13C 9B51
...
label_0df9:     CMPB    A, 0a6h                ; 0DF9 0 108 13C C5A6C2
                ...
                MOVB    r1, #051h              ; 0DFF 0 108 13C 9951
                ...
                MOVB    r1, #04ch              ; 0E09 0 108 13C 994C
...
label_1157:     LB      A, #0d7h               ; 1157 0 108 13C 77D7
                MOVB    r0, #065h              ; 1159 0 108 13C 9865
                JBR     off(00121h).4, label_1162 ; 115B 0 108 13C DC2104
                LB      A, #0d2h               ; 115E 0 108 13C 77D2
                MOVB    r0, #056h              ; 1160 0 108 13C 9856
...
label_116b:     MB      off(00121h).4, C       ; 116B 0 108 13C C4213C
                ...
                MOVB    r7, #013h              ; 117D 0 108 13C 9F13
...
label_117f:     LB      A, r7                  ; 117F 0 108 13C 7F
...
label_11a6:     CLR     er3                    ; 11A6 0 108 13C 4715
                LB      A, #084h               ; 11A8 0 108 13C 7784
                JBS     off(00118h).7, label_11af ; 11AA 0 108 13C EF1802
                LB      A, #085h               ; 11AD 0 108 13C 7785
...
label_16b8:     CLRB    PRPHF                  ; 16B8 0 080 ??? C51215
                ...
                MOVB    STTMC, #002h           ; 16DB 0 080 ??? C54A9802
                MOVB    STCON, #031h           ; 16DF 0 080 ??? C5509831
                MOVB    SRCON, #021h           ; 16E3 0 080 ??? C5549821
                MOVB    STTM, #0fch            ; 16E7 0 080 ??? C54898FC
                MOVB    STTMR, #0fch           ; 16EB 0 080 ??? C54998FC
                MOVB    SRTMC, #0c0h           ; 16EF 0 080 ??? C54E98C0
...
label_17dc:     MB      r0.0, C                ; 17DC 1 080 00F 2038
                ...
                LB      A, 09eh                ; 1841 0 080 213 F59E
                ANDB    A, #0c0h               ; 1843 0 080 213 D6C0
...
label_1861:     L       A, #00300h             ; 1861 1 080 213 670003
                ...
                L       A, #00500h             ; 1867 1 080 213 670005
...
label_1933:     SB      ACC.0                  ; 1933 1 080 1B3 C50618
                ...
                JBR     off(TMR0).0, label_1945 ; 193A 1 080 1B3 D83208
                RB      off(0001eh).0          ; 193D 1 080 1B3 C41E08
                L       A, #03eb7h             ; 1940 1 080 1B3 67B73E
...
label_1a65:     JBR     off(P3).1, label_1a80  ; 1A65 0 080 213 D92818
                ...
                SUBB    A, #050h               ; 1A7B 0 080 213 A650
                SMOVI                          ; 1A7D 0 080 213 04
...
label_1d71:     SRLB    A                      ; 1D71 0 108 3153 63
                ...
                CMPB    0a4h, #042h            ; 1D74 0 108 3153 C5A4C042
...
label_1d83:     CMPB    0a4h, #042h            ; 1D83 0 080 205 C5A4C042
...
label_1e3b:     INCB    off(000a9h)            ; 1E3B 1 080 1D5 C4A916
                ...
                SJ      label_1e9a             ; 1E49 0 080 1D5 CB4F
                DW  026cbh           ; 1E4B
...
label_1ec6:     CMP     SSP, #00260h           ; 1EC6 1 080 132 A0C06002
...
label_1f04:     VCAL    3                      ; 1F04 1 080 132 13
                ...
                JLT     label_1f3d             ; 1F08 1 080 132 CA33
...
label_2067:     JBR     off(0001fh).1, label_2081 ; 2067 0 080 213 D91F17
                LB      A, 0b5h                ; 206A 0 080 213 F5B5
                SUBB    A, 0b2h                ; 206C 0 080 213 C5B2A2
                JGE     label_2074             ; 206F 0 080 213 CD03
                STB     A, r0                  ; 2071 0 080 213 88
                CLRB    A                      ; 2072 0 080 213 FA
                SUBB    A, r0                  ; 2073 0 080 213 28
                                               ; 2074 from 206F (DD0,080,213)
label_2074:     CMPB    A, #002h               ; 2074 0 080 213 C602
                JLT     label_207d             ; 2076 0 080 213 CA05
                SB      0f1h.6                 ; 2078 0 080 213 C5F11E
                SJ      label_2082             ; 207B 0 080 213 CB05
                                               ; 207D from 2076 (DD0,080,213)
label_207d:     LB      A, off(000e9h)         ; 207D 0 080 213 F4E9
                JEQ     label_2082             ; 207F 0 080 213 C901
                                               ; 2081 from 35D0 (DD0,080,213)
                                               ; 2081 from 2055 (DD0,080,213)
                                               ; 2081 from 205B (DD0,080,213)
                                               ; 2081 from 2067 (DD0,080,213)
label_2081:     RC                             ; 2081 0 080 213 95
                                               ; 2082 from 207B (DD0,080,213)
                                               ; 2082 from 207F (DD0,080,213)
label_2082:     MB      off(P4).3, C           ; 2082 0 080 213 C42C3B
                RC                             ; 2085 0 080 213 95
...
label_20ef:     MB      off(P4IO).7, C         ; 20EF 0 080 213 C42D3F
...
label_2101:     LB      A, 0a6h                ; 2101 0 080 213 F5A6
                ...
                CMPB    0a4h, #015h            ; 2104 0 080 213 C5A4C015
...
label_218d:     MOV     X1, #03096h            ; 218D 1 080 0A3 609630
                ...
                MB      off(IRQ).7, C          ; 2198 0 080 0A3 C4183F
...
label_21a3:     CMPB    A, 0b3h                ; 21A3 0 080 0A3 C5B3C2
...
label_225b:     LB      A, 0a4h                ; 225B 0 080 0A4 F5A4
                ...
                MOV     X1, #032dfh            ; 2268 0 080 0A4 60DF32
                MOV     DP, #032f5h            ; 226B 0 080 0A4 62F532
                JBS     off(IRQ).7, label_2277 ; 226E 0 080 0A4 EF1806
                MOV     X1, #032cdh            ; 2271 0 080 0A4 60CD32
                MOV     DP, #032f1h            ; 2274 0 080 0A4 62F132
                                               ; 2277 from 226E (DD0,080,0A4)
label_2277:     LB      A, 0a4h                ; 2277 0 080 0A4 F5A4
                VCAL    1                      ; 2279 0 080 0A4 11
                JBR     off(P2).7, label_22a7  ; 227A 0 080 0A4 DF242A
                LC      A, [DP]                ; 227D 0 080 0A4 92A8
                JBR     off(P3SF).6, label_2286 ; 227F 0 080 0A4 DE2A04
                LC      A, 00002h[DP]          ; 2282 0 080 0A4 92A90200
...
label_22c6:     ST      A, off(00090h)         ; 22C6 1 080 0A4 D490
                ...
                L       A, #0397dh             ; 22E4 1 080 0A4 677D39
                JBS     off(P2).3, label_22ed  ; 22E7 1 080 0A4 EB2403
                L       A, #02dfeh             ; 22EA 1 080 0A4 67FE2D
                                               ; 22ED from 22E7 (DD1,080,0A4)
label_22ed:     CMP     0c4h, A                ; 22ED 1 080 0A4 B5C4C1
                MB      off(P2).3, C           ; 22F0 1 080 0A4 C4243B
...
label_23ec:     SC                             ; 23EC 0 080 205 85
...
label_2413:     MOVB    r2, #0dah              ; 2413 0 080 205 9ADA
                JBS     off(IRQ).7, label_241a ; 2415 0 080 205 EF1802
                MOVB    r2, #0dah              ; 2418 0 080 205 9ADA
...
label_242e:     MOV     DP, #00278h            ; 242E 0 080 205 627802
                ...
                MOVB    r2, #0ffh              ; 2438 0 080 205 9AFF
                MOVB    r6, off(0009fh)        ; 243A 0 080 205 C49F4E
                ...
                MOVB    r2, #0b3h              ; 2450 0 080 205 9AB3
...
label_2475:     LB      A, off(000a1h)         ; 2475 0 080 205 F4A1
                ...
                MOVB    r2, #0f5h              ; 247F 0 080 205 9AF5
...
label_252c:     J       label_36bc             ; 252C 0 080 205 03BC36
...
label_2564:     CMPB    0a4h, A                ; 2564 0 080 205 C5A4C1
                JGE     label_2573             ; 2567 0 080 205 CD0A
                LB      A, r1                  ; 2569 0 080 205 79
                CMPB    A, 0cbh                ; 256A 0 080 205 C5CBC2
                JGE     label_2573             ; 256D 0 080 205 CD04
                LB      A, r2                  ; 256F 0 080 205 7A
                CMPB    A, 0a6h                ; 2570 0 080 205 C5A6C2
                                               ; 2573 from 2567 (DD0,080,205)
                                               ; 2573 from 256D (DD0,080,205)
label_2573:     MB      off(P3SF).1, C         ; 2573 0 080 205 C42A39
                JLT     label_25c3             ; 2576 0 080 205 CA4B
...
label_2880:     L       A, #0fb00h             ; 2880 1 080 132 6700FB
...
label_2af1:     LB      A, r6                  ; 2AF1 0 080 205 7E
                RT                             ; 2AF2 0 080 205 01
                                               ; 2AF3 from 0773 (DD0,108,20E)
                                               ; 2AF3 from 0AEA (DD0,108,13C)
                                               ; 2AF3 from 0B0C (DD0,108,13C)
label_2af3:     CLR     A                      ; 2AF3 1 108 20E F9
                LB      A, r6                  ; 2AF4 0 108 20E 7E
                SWAPB                          ; 2AF5 0 108 20E 83
                ANDB    A, #00fh               ; 2AF6 0 108 20E D60F
                ADD     X1, A                  ; 2AF8 0 108 20E 9081
                MB      C, PSWL.5              ; 2AFA 0 108 20E A32D
                JLT     label_2b0a             ; 2AFC 0 108 20E CA0C
                LCB     A, 000ffh[X1]          ; 2AFE 0 108 20E 90ABFF00
                MOV     DP, A                  ; 2B02 0 108 20E 52
                CMPCB   A, 00100h[X1]          ; 2B03 0 108 20E 90AF0001
                MB      C, zp_PSWH.6           ; 2B07 0 108 20E C5052E
                                               ; 2B0A from 2AFC (DD0,108,20E)
label_2b0a:     MB      PSWL.4, C              ; 2B0A 0 108 20E A33C
                MOVB    r0, #010h              ; 2B0C 0 108 20E 9810
                                               ; 2B0E from 2B16 (DD0,108,20E)
label_2b0e:     DECB    r0                     ; 2B0E 0 108 20E B8
                DEC     X2                     ; 2B0F 0 108 20E 81
                LCB     A, 00000h[X2]          ; 2B10 0 108 20E 91AB0000
                ADDB    r7, A                  ; 2B14 0 108 20E 2781
                JGE     label_2b0e             ; 2B16 0 108 20E CDF6
                MOV     X2, A                  ; 2B18 0 108 20E 51
                SLL     X2                     ; 2B19 0 108 20E 91D7
                LB      A, #00fh               ; 2B1B 0 108 20E 770F
                MULB                           ; 2B1D 0 108 20E A234
                ADD     X1, A                  ; 2B1F 0 108 20E 9081
                CLR     A                      ; 2B21 1 108 20E F9
                LCB     A, [X1]                ; 2B22 1 108 20E 90AA
                ST      A, er0                 ; 2B24 1 108 20E 88
                LCB     A, 0000fh[X1]          ; 2B25 1 108 20E 90AB0F00
                MOV     USP, A                 ; 2B29 1 108 20E A18A
                INC     X1                     ; 2B2B 1 108 20E 70
                LCB     A, [X1]                ; 2B2C 1 108 20E 90AA
                ST      A, er1                 ; 2B2E 1 108 20E 89
                LCB     A, 0000fh[X1]          ; 2B2F 1 108 20E 90AB0F00
                MOV     X1, A                  ; 2B33 1 108 20E 50
                MB      C, PSWL.4              ; 2B34 1 108 20E A32C
                JLT     label_2b3c             ; 2B36 1 108 20E CA04
                SLL     er1                    ; 2B38 1 108 20E 45D7
                SLL     X1                     ; 2B3A 1 108 20E 90D7
                                               ; 2B3C from 2B36 (DD1,108,20E)
label_2b3c:     SCAL    label_2b63             ; 2B3C 1 108 20E 3125
                MOV     er0, USP               ; 2B3E 1 108 20E A148
                MOV     er1, X1                ; 2B40 1 108 20E 9049
                MOV     X1, A                  ; 2B42 1 108 20E 50
                SCAL    label_2b63             ; 2B43 1 108 20E 311E
                MOVB    r0, r7                 ; 2B45 1 108 20E 2748
                MOVB    r1, #000h              ; 2B47 1 108 20E 9900
                MB      C, off(00129h).2       ; 2B49 1 108 20E C4292A
                ROL     er0                    ; 2B4C 1 108 20E 44B7
                MOV     er2, X2                ; 2B4E 1 108 20E 914A
                MOV     er3, X1                ; 2B50 1 108 20E 904B
                CAL     label_2c32             ; 2B52 1 108 20E 32322C
                RB      PSWL.5                 ; 2B55 1 108 20E A30D
                JNE     label_2b61             ; 2B57 1 108 20E CE08
                L       A, DP                  ; 2B59 1 108 20E 42
                JEQ     label_2b61             ; 2B5A 1 108 20E C905
                L       A, er3                 ; 2B5C 1 108 20E 37
                                               ; 2B5D from 2B5E (DD1,108,20E)
label_2b5d:     SLL     A                      ; 2B5D 1 108 20E 53
                JRNZ    DP, label_2b5d         ; 2B5E 1 108 20E 30FD
                ST      A, er3                 ; 2B60 1 108 20E 8B
                                               ; 2B61 from 2B57 (DD1,108,20E)
                                               ; 2B61 from 2B5A (DD1,108,20E)
label_2b61:     L       A, er3                 ; 2B61 1 108 20E 37
                RT                             ; 2B62 1 108 20E 01
...
label_2b7a:     SUB     A, er1                 ; 2B7A 1 108 20E 29
                RT                             ; 2B7B 1 108 20E 01
                                               ; 2B7C from 0AED (DD0,108,13C)
                                               ; 2B7C from 0B0F (DD0,108,13C)
label_2b7c:     STB     A, r0                  ; 2B7C 0 108 13C 88
                L       A, off(00160h)         ; 2B7D 1 108 13C E460
...
label_2b85:     LB      A, 0a4h                ; 2B85 0 108 13C F5A4
                VCAL    0                      ; 2B87 0 108 13C 10
...
label_2dd2:     LB      A, ADCR3H              ; 2DD2 0 080 0A4 F567
...
label_2e08:     CMPB    r6, #01ah              ; 2E08 0 080 0A4 26C01A
                JLT     label_2e1a             ; 2E0B 0 080 0A4 CA0D
...
label_2eb6:     CLR     A                      ; 2EB6 1 100 ??? F9
                ...
                SBR     00130h[X1]             ; 2EC0 0 100 ??? C0300111
                SBR     0027bh[X1]             ; 2EC4 0 100 ??? C07B0211
...
label_3354:     LCB     A, 00038h[X1]          ; 3354 0 080 213 90AB3800
                ...
                DB  000h,000h,0F0h,017h

                DB  0FFh,0FFh,08Fh,042h ; 33E8
...
label_36d9:     JBR     off(0011bh).6, label_36e8 ; 36D9 0 108 13C DE1B0C
                CMPB    0a4h, #018h            ; 36DC 0 108 13C C5A4C018
...
label_36ef:     CMPB    A, 0a6h                ; 36EF 0 108 13C C5A6C2
                ...
                CMPB    0a4h, #013h            ; 36F7 0 108 13C C5A4C013
...
label_3703:     MB      C, P1.1                ; 3703 1 108 13C C52229
                ...
                LB      A, #0e0h               ; 3708 0 108 13C 77E0
                JBR     off(00129h).0, label_370f ; 370A 0 108 13C D82902
                LB      A, #0d8h               ; 370D 0 108 13C 77D8
...
label_3741:     J       label_0ba9             ; 3741 1 108 13C 03A90B
                DB  0FFh,0FFh,0FFh,0FFh,0FFh,0FFh,0FFh,0FFh ; 3744
...
label_4015:     CLR     0f4h                   ; 4015 0 080 132 B5F415
                ...
                JEQ     label_401e             ; 4019 0 080 132 C903
                J       label_1f2d             ; 401B 0 080 132 032D1F
...
label_4037:     LB      A, off(001d0h)         ; 4037 0 108 13C F4D0
                ...
                CMPB    0a4h, #026h            ; 4044 0 108 13C C5A4C026
...
label_41ab:     MOVB    WDT, #03ch             ; 41AB 0 ??? ??? C511983C
                MOV     SSP, #00260h           ; 41AF 0 ??? ??? A0986002
...
label_41b6:     L       A, #041d3h             ; 41B6 1 108 13C 67D341
                ...
                MOV     DP, #031dch            ; 41BC 1 108 13C 62DC31
                L       A, #041dbh             ; 41BF 1 108 13C 67DB41
                                               ; 41C2 from 41B9 (DD1,108,13C)
label_41c2:     MOV     er0, #003cfh           ; 41C2 1 108 13C 4498CF03
                MB      C, 0f2h.7              ; 41C6 1 108 13C C5F22F
                JGE     label_41d0             ; 41C9 1 108 13C CD05
                MOV     DP, A                  ; 41CB 1 108 13C 52
                MOV     er0, #003e0h           ; 41CC 1 108 13C 4498E003
                                               ; 41D0 from 41C9 (DD1,108,13C)
...
label_41fb:     CMPB    0a6h, #069h            ; 41FB 0 108 3153 C5A6C069
