...
;label_41b6:     L       A, #041d3h             ;  lod restart
;                JBS     off(00118h).7, label_41c2 ; if auto jump
;                MOV     DP, #031dch            ; else, load 31dch
;                L       A, #041dbh             ; load new restart
;                                               ;
;label_41c2:     MOV     er0, #003cfh           ; speed lim
;                MB      C, 0f2h.7              ; check revlimit bit
;                JGE     label_41d0             ; if not on revlimit, jump
;                MOV     DP, A                  ; load restart
;                MOV     er0, #003e0h           ; speed lim
;                                               ; 41D0 from 41C9 (DD1,108,13C)
;label_41d0:     J       label_0d0a             ; jump back

                DB  062h,0DCh,031h ; 0D07
                                               ; 0D0A from 41D0 (DD1,108,13C)
label_0d0a:     L       A, 0c4h                ; load speed
                CMP     A, er0                 ; compare to value
                NOP                            ;
                NOP                            ;
                JLT     label_0d20             ; if speedval <
                INC     DP                     ; 31ddh
                INC     DP                     ; 31deh
                JBS     off(00129h).7, label_0d20 ; if vtec, jump
                INC     DP                     ; 31dfh
                INC     DP                     ; 31e0h
                CMPB    0a4h, #02eh            ;
                JLT     label_0d20             ; if warm, jump
                INC     DP                     ;
                INC     DP                     ; 31e1h
...
logger_table:	DB  099h,000h ;10 water temp
                ...
                DB  0deh,000h ;24 final ignition val
                ...
                DB  0e1h,001h ;29 fuel row interpolation
                DB  0e2h,001h ;2a ignition row interpolation
